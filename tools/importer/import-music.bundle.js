...
var CustomImportScript = (() => {
  ...
  // tools/importer/import-music.js
  var import_music_exports = {};
  __export(import_music_exports, {
    default: () => import_music_default
  });

  // tools/importer/parsers/cards-releases.js
  function parse(element, { document: document2 }) {
    ...
    items.forEach((item) => {
      ...
      const listenLabel = [...meta.querySelectorAll(":scope > .release-links-label")][0] || (video ? null : meta.querySelector(".release-links-label"));
    ...
    const block = WebImporter.Blocks.createBlock(document2, { name: "cards-releases", cells });
    element.replaceWith(block);
  }

  // tools/importer/transformers/grod-cleanup.js
  ...
  // tools/importer/transformers/grod-sections.js
  ...
  return __toCommonJS(import_music_exports);
})();
